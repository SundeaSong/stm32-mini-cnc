...
uint8_t settings_store_global_setting(int parameter, float value) {
  switch(parameter) {
    ...
    case 3: 
      ...
      settings.pulse_microseconds = myround(value); break;
    case 4: settings.default_feed_rate = value; break;
    case 5: settings.default_seek_rate = value; break;
    case 6: settings.invert_mask = Trunc(value); break;
    case 7: settings.stepper_idle_lock_time = myround(value); break;
    ...
    case 11: settings.n_arc_correction = myround(value); break;
    case 12: settings.decimal_places = myround(value); break;
    case 13:
    ...
    case 21: settings.homing_debounce_delay = myround(value); break;
