...
//bb  LIMIT_PCMSK &= ~LIMIT_MASK; // Disable hard limits pin change register for cycle duration
...
//bb  if (bit_istrue(settings.flags,BITFLAG_HARD_LIMIT_ENABLE)) 
//bb		{ LIMIT_PCMSK |= LIMIT_MASK; }
  // Finished! 
}
